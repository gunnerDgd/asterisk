...
run_async()                                                    {
    ...
    u8_t *buf0 = new (u8_t[13]); mem_copy(buf0, "Hello World1\n", 13);
    u8_t *buf1 = new (u8_t[13]); mem_copy(buf1, "Hello World2\n", 13);
    u8_t *buf2 = new (u8_t[13]); mem_copy(buf2, "Hello World3\n", 13);
    fut  *fut1 = file_write(file_1, buf0, 13);
    fut  *fut2 = file_write(file_1, buf1, 13);
    fut  *fut3 = file_write(file_1, buf2, 13);
    await(fut1);
    await(fut2);
    await(fut3);
